      ...
      <main className="flex-1 pl-64">
        <div className="p-8">
          <div className="mb-8">
            ...
            <p className="mt-2 text-muted-foreground">View and manage workflow execution history</p>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-border bg-muted/50">
                    <th className="p-4 text-left text-sm font-medium text-muted-foreground">Task ID</th>
                    <th className="p-4 text-left text-sm font-medium text-muted-foreground">Workflow ID</th>
                    <th className="p-4 text-left text-sm font-medium text-muted-foreground">Status</th>
                    <th className="p-4 text-left text-sm font-medium text-muted-foreground">Steps</th>
